...
public interface IEmployee {
    Employee create(Employee employee,UUID storeId) throws CreationFailedException, NotAuthenticatedException, AccessDeniedException,NotAuthorizedException, NotAuthenticatedException;
    ...
    List<Employee> getAllByStoreId(UUID storeId);
